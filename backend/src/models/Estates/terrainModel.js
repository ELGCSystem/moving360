  ...
  [
    {
      ...
      generalFeatures: {
        ...
        landCoverFactor: { type: Number, trim: true, required: true },
        linealRightMeasure: { type: String, trim: true, required: true },
        linealLeftMeasure: { type: String, trim: true, required: true },
        zoning: { type: String, trim: true, required: true },
      ...
      installations: {
        ...
        paddock: { type: Boolean, trim: true, required: true },
        creamery: { type: Boolean, trim: true, required: true },
      },
      services: {
...
const Terrain = mongoose.models.estates || mongoose.model('estates', terrainSchema);
