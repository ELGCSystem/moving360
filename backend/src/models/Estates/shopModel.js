  ...
  [
    {
      ...
      generalFeatures: {
        ...
        cornerDistance: { type: String, trim: true, required: true },
      },
      otherEnvironments: {
      ...
      installations: {
        ...
        window: { type: Boolean, trim: true, required: true },
...
const Shop = mongoose.models.estates || mongoose.model('estates', shopSchema);
export default Shop;