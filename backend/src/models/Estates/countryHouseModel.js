...
const countryHouseSchema = new mongoose.Schema(
  [
    {
      dataBasic: {
      ...
      installations: {
        ...
        basketballCourt: { type: Boolean, trim: true, required: true },
        volleyballCourt: { type: Boolean, trim: true, required: true },
        hockeyCamp: { type: Boolean, trim: true, required: true },
        paddleCourt: { type: Boolean, trim: true, required: true },
      },
      services: {
...
const CountryHouse = mongoose.models.estates || mongoose.model('estates', countryHouseSchema);
