...
const goodwillSchema = new mongoose.Schema(
  [
    {
      dataBasic: {
      ...
      generalFeatures: {
        ...
        cornerDistance: { type: Number, trim: true, required: true },
        monthlyIncome: { type: String, trim: true, required: true },
      },
      otherEnvironments: {
...
const Goodwill = mongoose.model('estates', goodwillSchema);
